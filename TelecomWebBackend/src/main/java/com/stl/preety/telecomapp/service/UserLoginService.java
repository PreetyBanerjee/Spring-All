...
import com.stl.preety.telecomapp.jwt.SignupDetails;
import com.stl.preety.telecomapp.jwt.Signupjwt;
...
public class UserLoginService {
	...
	public String login(User user) {
		try {
			...
			return "$2a$12$CbpZHraNJOfA0K8hqymquupdbj8d07ydXAqbG3aAEz5VKUcgY.JzC";
		}
	}
